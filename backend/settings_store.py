...
SPECS: tuple[SettingSpec, ...] = (
    ...
    SettingSpec(
        ...
        description="Maximum wait for one Chrome DevTools operation. Keep this "
                    "shorter than the whole render budget so a wedged frame can "
                    "trigger HyperFrames' lower-concurrency recovery.",
    ),
    # ── Direction ────────────────────────────────────────────────────────
    SettingSpec(
    ...
    SettingSpec(
        ...
        description="Minimum start-to-start spacing shared by all OpenCLI Gemini "
                    "and ChatGPT web commands, including concurrent idle tasks.",
    ),
    SettingSpec(
